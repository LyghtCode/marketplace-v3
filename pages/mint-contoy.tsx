...
const myNftDropContractAddress = "0x78D06B1F19dDb6Ba5765F6A60D29EF6059c89a47";

const Contoy: NextPage = () => {
  const { contract: nftDrop } = useContract(myNftDropContractAddress, "edition-drop");
  ...
  console.log("unclaimed supply is:"  + unclaimedSupply.data);
                  ...
                  <div className={styles.mintContainer}>
                    {isSoldOut ? (
                      ...
                      <Web3Button
                        ...
                        action={(cntr) => cntr.erc1155.claim(0,quantity)}
